...
<navbar>
    <div class="flex justify-between px-6 bg-blue-900 items-center py-4">
      ...
      <h1 class="text-white font-bold text-xl align-middle">Admin Dashboard</h1>
  ...
  <navbar>
    <div class="absolute top-0 w-60 h-full bg-slate-300 p-6">
      ...
      <ul class="flex flex-col space-y-6 mt-14 border-t py-6">
        <a href="/alluser1"><li class="hover:bg-red-300 transition duration-500">User Page</li></a>
        <li class="hover:bg-red-300 transition duration-500">Create New User</li>
